...
export function InstagramFeed({ data }) {
    ...
    <section className="py-24 bg-[var(--background)]">
      <div className="container mx-auto px-4 md:px-8">
        ...
        <div className="mt-12 text-center">
          <a 
            href="https://instagram.com/ameyanewyork" 
            target="_blank" 
            rel="noreferrer" 
            className="inline-block px-8 py-3 border border-[var(--primary)] text-[var(--primary)] hover:bg-[var(--primary)] hover:text-white transition-all duration-300 rounded-sm uppercase tracking-widest text-xs font-medium"
          >
            Follow on Instagram
          </a>
        </div>
