  ...
  return <footer className="bg-[#f8f6f1] text-[var(--foreground)] pt-16 md:pt-24 pb-8 font-sans border-t border-[var(--border)] relative z-40">
      <div className="container mx-auto px-4 md:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-16">
          ...
          <div className="md:col-span-2 lg:col-span-1">
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-[var(--muted-foreground)] hover:text-[var(--primary)] transition-colors"><Instagram size={20} /></a>
              <a href="#" className="text-[var(--muted-foreground)] hover:text-[var(--primary)] transition-colors"><Facebook size={20} /></a>
              <a href="#" className="text-[var(--muted-foreground)] hover:text-[var(--primary)] transition-colors"><Twitter size={20} /></a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-[var(--muted-foreground)]">
              ...
              <li><Link to="/category/bracelets" className="hover:text-[var(--primary)] transition-colors">Bracelets & Bangles</Link></li>
              <li><Link to="/category/love-engagement" className="hover:text-[var(--primary)] transition-colors">Love & Engagement</Link></li>
              <li><Link to="/category/sets" className="hover:text-[var(--primary)] transition-colors">Sets</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-[var(--muted-foreground)]">
              <li><Link to="/our-story" className="hover:text-[var(--primary)] transition-colors">Our Story</Link></li>
              <li><Link to="/careers" className="hover:text-[var(--primary)] transition-colors">Careers</Link></li>
               <li><Link to="/journal" className="hover:text-[var(--primary)] transition-colors">Journal</Link></li>
          ...
          <div className="md:col-span-2 lg:col-span-1">
            ...
            <form className="flex flex-col space-y-3 w-full max-w-md" onSubmit={e => e.preventDefault()}>
              <div className="relative">
                ...
                <button type="submit" className="absolute right-0 top-2 text-[var(--muted-foreground)] hover:text-[var(--primary)] transition-colors">
                  <ArrowRight size={16} />
                </button>
              </div>
            </form>
        ...
        <div className="pt-8 border-t border-[var(--border)] flex flex-col md:flex-row justify-between items-center text-xs text-[var(--muted-foreground)]">
          <p> Designed And Developed By <a href="https://www.syntiaro.com/" target="_blank" rel="noopener noreferrer" className="hover:text-[var(--primary)] transition-colors">SYNTIARO</a>.</p>
          <div className="flex space-x-6 mt-4 md:mt-0">
            <Link to="/privacy" className="hover:text-[var(--primary)]">Privacy Policy</Link>
            <Link to="/terms" className="hover:text-[var(--primary)]">Terms of Service</Link>
          </div>
        </div>
      </div>
    </footer>;
